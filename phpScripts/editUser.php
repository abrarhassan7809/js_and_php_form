...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update the user data in the database (you should use prepared statements to prevent SQL injection)
    $conn = new mysqli(DB_HOST, DB_USER, DB_PASS, DB_NAME);
    if ($conn->connect_error) {
        die("Connection failed: " . $conn->connect_error);
    }

    $sql = "UPDATE users SET username='$username', role='$role' WHERE employeeID='$employeeID'";
